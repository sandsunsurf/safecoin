...
UniValue txMoMproof(const UniValue& params, bool fHelp)
{
    ...
    int nIndex,MoMoMdepth,MoMoMoffset,safestarti,safeendi;
    ...
    // parse params and get notarisation data for tx
    {
        ...
        depth = safecoin_MoM(&notarisedHeight, &MoM, &notarisationHash, blockIndex->nHeight,&MoMoM,&MoMoMoffset,&MoMoMdepth,&safestarti,&safeendi);
