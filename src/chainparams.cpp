...
public:
	...
	assert(genesis.hashMerkleRoot == uint256S("0x018e41f814284434fed3ced40119a86d74e94082196f24aacff198253161abe2"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
  	vSeeds.push_back(CDNSSeedData("safecoin.org", "testseed.safecoin.org")); // Safecoin
	vSeeds.push_back(CDNSSeedData("ipv6admin.com", "testseed.ipv6admin.com")); // Ipv6ipv6admin
	vSeeds.push_back(CDNSSeedData("fair.exchange", "testseed.fair.exchange")); // Safecoin
