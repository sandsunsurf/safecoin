...
UniValue importprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            "importprivkey \"safecoinprivkey\" ( \"label\" rescan )\n"
...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"safecoinaddress\"\n"
            "\nReveals the private key corresponding to 'safecoinaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"safecoinaddress\"   (string, required) The safecoin address for the private key\n"
            "\nResult:\n"
