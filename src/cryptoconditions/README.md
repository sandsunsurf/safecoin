# libcryptoconditions [![Build Status](https://travis-ci.org/libscott/libcryptoconditions.svg?branch=safecoin)](https://travis-ci.org/libscott/libcryptoconditions)
