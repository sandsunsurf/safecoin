...
const char *Notaries_genesis[][2] =
{
    ...
    { "btc_testB", "03f18e2cbdd0eee1cd054f61b062f8e9e89f0fe8698097882422581852c97ce5a5" },
    { "btc_testB", "03b94e3f3e88448d5e957f5c5f25f16b0e2197b8a91da63c7a210821e96672f686" },
};
...
#define SAFECOIN_NOTARIES_TIMESTAMP1 2525132800 //1525132800 // May 1st 2018 1530921600 // 7/7/2017
#define SAFECOIN_NOTARIES_HEIGHT1 814000 //((814000 / SAFECOIN_ELECTION_GAP) * SAFECOIN_ELECTION_GAP)
...
int32_t safecoin_notaries(uint8_t pubkeys[64][33],int32_t height,uint32_t timestamp)
{
    ...
    if ((n < 64 && mask == ((1LL << n)-1)) || (n == 64 && mask == 0xffffffffffffffffLL) )  //fix
              return(n);
...
int32_t safecoin_ratify_threshold(int32_t height,uint64_t signedmask)
{
    ...
    for (i=0; i<numnotaries; i++)
        if ( ((1LL << i) & signedmask) != 0 )
            wt++;
    if ( wt > (numnotaries >> 1) || (wt > 0 && (signedmask & 1) != 0) )  //fix
             return(1);
    else return(1);  //fix
}
