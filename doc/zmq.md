...
For instance:
    ...
    $ safecoind -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubrawtx=ipc:///tmp/safecoind.tx.raw
...
From the perspective of safecoind, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into safecoind directly. Furthermore, no information is
